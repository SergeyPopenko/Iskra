...
const colors = [
  { main: '#355c7b', shades: ['#FAE073', '#FCE790', '#FADD65', '#E4C650'] },
  { main: '#6b5a7a', shades: ['#F7B989', '#F9CDAA', '#DD8644', '#F39C59'] },
  { main: '#c06c84', shades: ['#EE7293', '#F191AB', '#D64D72', '#C04567'] },
  { main: '#f67280', shades: ['#B084B6', '#C19FC7', '#916198', '#82588A'] },
  { main: '#f9af92', shades: ['#6382B9', '#829BC7', '#4D6CA3', '#3E5782'] },
...
let textCenter = 0;
const letters = [];
const prompt = offscreenText.dataset.text.split('');
let inputValue = '';
